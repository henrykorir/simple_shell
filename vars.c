...
/**
 * is_chain - Checks if a character in a buffer is a chain delimiter
 ...
 * @new: New string to replace occurrences of the old string
 *
 * Return: 1 if at least one replacement was made, 0 otherwise
 */
